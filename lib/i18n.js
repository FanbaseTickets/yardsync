export const translations = {
  en: {
    ...
    settings: {
      ...
      per_month:       '/month',
      per_year:        '/year',
      upgrade_title:   'Upgrade to Annual — Save $78/year',
      upgrade_body:    'Switch from monthly to annual billing and save $78 per year.',
      upgrade_detail:  '$390/year instead of $468/year ($39 × 12)',
      upgrade_button:  'Upgrade to Annual',
      upgrade_confirm: 'Confirm Upgrade',
      upgrade_success: 'Upgraded to Annual Plan! You saved $78.',
      upgrade_saving:  'You save $78/year vs monthly',
      upgrade_modal_body: "You'll be charged $390 today. Your subscription switches to annual billing immediately. You save $78 compared to monthly.",
    },
    // Onboarding
    onboarding: {
      ...
      step_square:   'Connect payment account',
      step_bank:     'Bank account connected',
    ...
    // Subscribe
    subscribe: {
      choose_plan:      'Choose your plan to get started',
      monthly:          'Monthly',
      annual:           'Annual',
      ...
      per_month:        'per month',
      per_year:         'per year',
      billed_annually:  '$32.50/month billed annually',
      unlimited:        'Unlimited clients',
      square:           'Invoice integration',
      auto_sms:         'Auto SMS reminders',
      bilingual:        'English & Spanish support',
      everything:       'Everything in Monthly',
      best_value:       'Best value — 2 months free',
      priority:         'Priority support',
      early_access:     'Early access to new features',
      setup_title:      'Professional Setup',
      setup_desc:       'We set up your clients, packages & schedule for you',
      setup_1:          'We enter all your existing clients',
      setup_2:          'Set up your service packages',
      setup_3:          'Schedule recurring visits',
      setup_4:          'Ready to use on day one',
      one_time:         'one-time',
      monthly_plan:     'Monthly plan',
      annual_plan:      'Annual plan',
      pro_setup:        'Professional setup',
      due_today:        'Due today',
      start_monthly:    'Start Monthly Plan',
      start_annual:     'Start Annual Plan',
      footer:           'Secured by Stripe · Cancel anytime · No hidden fees',
      sign_out:         'Sign out',
      checkout_cancel:  'Checkout cancelled — choose a plan to continue',
    ...
    materials: {
      ...
      remove:        'Remove',
      placeholder:   'e.g. Fertilizer, Mulch, Paint...',
      noMaterials:   'No materials added',
      attachedBadge: 'Materials',
    },
    // Status badges
    status: {
      active:    'Active',
  ...
  es: {
    ...
    settings: {
      ...
      per_month:       '/mes',
      per_year:        '/año',
      upgrade_title:   'Cambiar a Anual — Ahorra $78/año',
      upgrade_body:    'Cambia de facturación mensual a anual y ahorra $78 al año.',
      upgrade_detail:  '$390/año en vez de $468/año ($39 × 12)',
      upgrade_button:  'Cambiar a Anual',
      upgrade_confirm: 'Confirmar actualización',
      upgrade_success: '¡Cambiaste al Plan Anual! Ahorraste $78.',
      upgrade_saving:  'Ahorras $78/año vs mensual',
      upgrade_modal_body: 'Se te cobrarán $390 hoy. Tu suscripción cambia a facturación anual de inmediato. Ahorras $78 en comparación con el plan mensual.',
    },
    // Onboarding
    onboarding: {
      ...
      step_square:   'Conectar cuenta de pago',
      step_bank:     'Cuenta bancaria conectada',
    ...
    // Subscribe
    subscribe: {
      choose_plan:      'Elige tu plan para comenzar',
      monthly:          'Mensual',
      annual:           'Anual',
      ...
      per_month:        'por mes',
      per_year:         'por año',
      billed_annually:  '$32.50/mes facturado anualmente',
      unlimited:        'Clientes ilimitados',
      square:           'Integración de facturas',
      auto_sms:         'Recordatorios SMS automáticos',
      bilingual:        'Soporte en inglés y español',
      everything:       'Todo lo del plan Mensual',
      best_value:       'Mejor valor — 2 meses gratis',
      priority:         'Soporte prioritario',
      early_access:     'Acceso anticipado a nuevas funciones',
      setup_title:      'Configuración Profesional',
      setup_desc:       'Configuramos tus clientes, paquetes y horario por ti',
      setup_1:          'Ingresamos todos tus clientes existentes',
      setup_2:          'Configuramos tus paquetes de servicio',
      setup_3:          'Programamos visitas recurrentes',
      setup_4:          'Listo para usar desde el primer día',
      one_time:         'una vez',
      monthly_plan:     'Plan Mensual',
      annual_plan:      'Plan Anual',
      pro_setup:        'Configuración profesional',
      due_today:        'A pagar hoy',
      start_monthly:    'Comenzar Plan Mensual',
      start_annual:     'Comenzar Plan Anual',
      footer:           'Protegido por Stripe · Cancela cuando quieras · Sin tarifas ocultas',
      sign_out:         'Cerrar sesión',
      checkout_cancel:  'Pago cancelado — elige un plan para continuar',
      checkout_error:   'No se pudo iniciar el pago — intenta de nuevo',
    },
    // Materials
    materials: {
      title:         'Materiales',
      ...
      total:         'Total',
      subtotal:      'Subtotal de materiales',
      save:          'Guardar materiales',
      saved:         '¡Materiales guardados!',
      remove:        'Eliminar',
      placeholder:   'ej. Fertilizante, Abono, Pintura...',
      noMaterials:   'Sin materiales agregados',
      attachedBadge: 'Materiales',
    },
    // Status badges
    status: {
      active:    'Activo',
    ...
    calendar_extra: {
      ...
      open_maps:     'Toca para abrir en Maps',
    },
    // Package types
    packages: {
      monthly:   'Mensual',
