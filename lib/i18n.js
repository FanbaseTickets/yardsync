export const translations = {
  en: {
    ...
    settings: {
      ...
      sms_note:        'SMS reminders will automatically send in the selected language',
  ...
  es: {
    ...
    settings: {
      ...
      sms_note:        'Los recordatorios SMS se enviarán automáticamente en el idioma seleccionado',
