...
//
// ⚠️ PRICING LEVER — Jay sets this number. Ships at 0 (disabled) so behavior is
// unchanged until a value is chosen. With a cap, the effective % only starts
// dropping above (cap / 0.055): e.g. a $75 cap is "5.5% up to ~$1,364, then
// flat $75 above that". Set in cents, e.g. 7500 for a $75 ceiling.
export const FEE_CAP_CENTS = Number(process.env.NEXT_PUBLIC_FEE_CAP_CENTS) || 0
