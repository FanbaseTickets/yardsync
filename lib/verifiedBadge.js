...
// webhook + the payment_intent.succeeded handler). firstPaidInvoiceId is stamped
// on EVERY account's first paid client invoice — both via free-access activation
// and, for other accounts, a decoupled marker in the webhook (see webhook route).
