    ...
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <section className="space-y-6 text-gray-700 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p>{es
            ? 'YardSync ofrece herramientas de gestión de servicios que incluyen programación de clientes, facturación mediante Stripe Connect, control de materiales, redacción de SMS asistida por IA, almacenamiento de imágenes de logotipo y headshot, una tarjeta de presentación digital pública con código QR y formulario de captación de prospectos (incluyendo autocompletado de direcciones y ubicación opcional del dispositivo), gestión de equipo/cuadrilla con cuentas de trabajador de acceso limitado, recompensas de suscripción por volumen y recordatorios de cita por SMS a través de Twilio.'
            : 'YardSync provides field service management tools including client scheduling, invoicing via Stripe Connect, materials tracking, AI-assisted SMS drafting, logo and headshot image storage, a public digital business card with QR code and prospect-intake (lead capture) form (including address autocomplete and optional device location), team/crew management with scoped worker accounts, volume-based subscription rewards, and SMS appointment reminders via Twilio.'}</p>
        </div>
        ...
        <div>
          ...
          {/* PENDING LEGAL REVIEW (added 2026-07-05): Crew per-seat recurring add-on ($15/mo per active worker) — monthly cadence even on annual base, proration, additive to the 5.5% fee + Early Adopter lock. Draft language, counsel to confirm disclosure adequacy under ROSCA / state auto-renewal (ARL) rules. */}
          <p className="mt-2">{es
            ? <><strong>Asientos de cuadrilla (opcional).</strong> Si invita a miembros de su equipo ("trabajadores") a su cuenta, cada trabajador activo es un "asiento" facturable que agrega <strong>$15 por mes</strong> a su suscripción, además de la cuota base de $39/mes (o $390/año) y separado de —y adicional a— la tarifa de aplicación del 5.5% por factura. Los asientos siempre se facturan de forma <strong>mensual</strong>: si su plan base es mensual, los asientos aparecen como un segundo cargo en esa misma suscripción mensual (un solo cargo combinado); si su plan base es anual, la base se cobra por año y los asientos se cobran por separado en una suscripción <strong>mensual</strong> dedicada. Los asientos se prorratean al agregar o quitar un trabajador. <strong>Agregar un miembro de cuadrilla genera el cargo recurrente de $15/mes por ese asiento, que continúa hasta que usted lo elimine</strong> desde Configuración → Equipo. Al quitar un trabajador se detiene la facturación de ese asiento y se aplica un crédito prorrateado. El precio por asiento es adicional y no forma parte de la tarifa de aplicación del 5.5%, por lo que no está cubierto por el Bloqueo de Precio para Primeros Usuarios de la Sección 6; YardSync puede ajustar el precio por asiento para cuentas nuevas con al menos 30 días de aviso publicado en esta página. Cobrar por asientos requiere una suscripción activa.</>
            : <><strong>Crew seats (optional).</strong> If you invite team members ("workers") to your account, each active worker is a billable "seat" that adds <strong>$15 per month</strong> to your subscription, on top of the $39/mo (or $390/yr) base fee and separate from — and in addition to — the 5.5% per-invoice application fee. Seats always bill <strong>monthly</strong>: if your base plan is monthly, seats appear as a second charge on that same monthly subscription (one combined charge); if your base plan is annual, the base is charged yearly and seats are charged separately on a dedicated <strong>monthly</strong> subscription. Seats are prorated when you add or remove a worker. <strong>Adding a crew member incurs the recurring $15/mo charge for that seat, which continues until you remove them</strong> from Settings → Team. Removing a worker stops that seat's billing and applies a prorated credit. Seat pricing is additive and is not part of the 5.5% application fee, so it is not covered by the Early Adopter Pricing Lock in Section 6; YardSync may adjust seat pricing for new accounts with at least 30 days' notice posted to this page. Charging for seats requires an active subscription.</>}</p>
          <p className="mt-2">{es
        ...
        <div>
          ...
          {/* PENDING LEGAL REVIEW (added 2026-07-05): Crew/worker accounts + owner responsibility for their crew's access and use. Draft language, counsel to confirm scope of owner liability for worker acts + worker data-access adequacy. */}
          <p className="mt-2">{es
            ? <><strong>Miembros de cuadrilla y cuentas de trabajador.</strong> Un proveedor de servicio (el "propietario" del negocio) puede invitar a miembros de su equipo ("trabajadores") por teléfono o correo electrónico para crear cuentas de trabajador de acceso limitado. Una cuenta de trabajador ve únicamente los trabajos que se le asignan —limitado al nombre del cliente, la dirección del servicio y la descripción del servicio— y <strong>nunca</strong> ve precios, tarifas, facturas, pagos, la lista completa de clientes ni la configuración de la cuenta. El propietario es el único responsable de las personas que invita como trabajadores, de que la invitación de esas personas sea apropiada, y de todo acceso y uso de la plataforma por parte de sus trabajadores, incluyendo el manejo por parte del trabajador de la información de cliente que se le muestra. El propietario acepta invitar solo a personas autorizadas, eliminar sin demora a los trabajadores que ya no deban tener acceso, y es responsable ante YardSync de los actos y omisiones de sus trabajadores como si fueran propios. Una persona puede ser propietaria de su propio negocio y a la vez trabajadora en otras cuadrillas; en cada caso su acceso está limitado al rol correspondiente.</>
            : <><strong>Crew members and worker accounts.</strong> A service provider (the business "owner") may invite team members ("workers") by phone or email to create scoped worker accounts. A worker account sees only the jobs assigned to it — limited to the client's name, service address, and service description — and <strong>never</strong> sees pricing, fees, invoices, payments, the full client book, or account settings. The owner is solely responsible for the people they invite as workers, for the appropriateness of inviting those people, and for all access to and use of the platform by their workers, including a worker's handling of the client information shown to them. The owner agrees to invite only authorized individuals, to promptly remove workers who should no longer have access, and is responsible to YardSync for its workers' acts and omissions as if they were the owner's own. A person may both own their own business and be a worker in other crews; in each case their access is limited to the applicable role.</>}</p>
        </div>
