    ...
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <section className="space-y-6 text-gray-700 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p>{es
            ? 'No vendemos su información personal. Los datos de suscripción móvil y los números de teléfono recopilados para comunicaciones por SMS nunca se compartirán con terceros ni afiliados con fines de marketing o promoción. Solo compartimos datos con proveedores de confianza necesarios para operar la plataforma (Firebase, Stripe, Twilio, Anthropic, Geoapify). No compartimos datos con terceros con fines de marketing. Los detalles de la tarjeta de su suscripción son almacenados por Stripe bajo los términos de Stripe; YardSync solo almacena un identificador de cliente y un token del método de pago, no el número de su tarjeta.'
            : 'We do not sell your personal information. Mobile opt-in data and phone numbers collected for SMS communications will never be shared with third parties or affiliates for marketing or promotional purposes. We share data only with trusted service providers necessary to operate the platform (Firebase, Stripe, Twilio, Anthropic, Geoapify). We do not share data with third parties for marketing purposes. Card details for your subscription are stored by Stripe under Stripe’s terms; YardSync stores only a customer identifier and a payment-method token, not your card number.'}</p>
        ...
        {/* PENDING LEGAL REVIEW (added 2026-07-05): Geoapify sub-processor + precise geolocation. Counsel to confirm the consent standard for precise geolocation — under the TX TDPSA precise geolocation (within a 1,750-ft radius) is "sensitive data" requiring opt-in consent; confirm whether the user-initiated button + native browser permission prompt is a sufficient "clear affirmative act," or whether an explicit in-form consent notice at the point of capture is required. */}
        <div>
          ...
          <p className="mt-2">{es
            ? 'El uso de la ubicación es totalmente opcional: nunca se captura la ubicación de su dispositivo a menos que usted toque el botón y otorgue el permiso del navegador, y siempre puede escribir la dirección manualmente. YardSync guarda únicamente el texto de la dirección resultante; no almacenamos las coordenadas precisas de su dispositivo. El texto de la dirección y las coordenadas que se comparten con Geoapify se procesan según la Política de Privacidad y los Términos de Geoapify, disponibles en '
            : 'Use of location is entirely optional: your device location is never captured unless you tap the button and grant the browser permission, and you can always type the address manually. YardSync stores only the resulting address text; we do not store your device\'s precise coordinates. The address text and coordinates shared with Geoapify are processed under Geoapify\'s own Privacy Policy and Terms, available at '}<a href="https://www.geoapify.com/privacy-policy/" className="text-green-700 underline" target="_blank" rel="noopener noreferrer">geoapify.com/privacy-policy</a>.</p>
        </div>
